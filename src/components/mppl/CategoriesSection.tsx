...
const categories = [
  ...
  { id: 17, name: "DOUBLES 30+", tagline: "Senior category", age: "30+", type: "Women" },
  { id: 18, name: "SINGLES 40+", tagline: "Senior category", age: "40+", type: "Men" },
  { id: 19, name: "SINGLES 50+", tagline: "Senior category", age: "50+", type: "Men" }
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4 auto-rows-max">
            {categories.map((cat, i) => (
              <div 
                key={cat.id} 
                className="p-6 border-2 border-neon-green bg-pure-black text-net-white transition-all cursor-pointer group hover:bg-neon-green hover:text-pure-black"
              >
            ...
            {/* "More Soon" Block */}
            <div className="p-6 border-2 border-dashed border-neon-green bg-pure-black flex flex-col items-center justify-center text-center min-h-[200px] hover:bg-neon-green transition-all cursor-pointer group">
