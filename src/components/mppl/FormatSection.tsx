      ...
      <div className="max-w-[1400px] mx-auto relative z-10 pattern-content text-center">
        ...
        <div className="relative mt-16 mb-24 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 relative z-10">
            {[
              { num: '01', title: 'QUALIFYING ROUNDS', desc: '4 legs across Indore, Bhopal & more. Winner & Runner-up of each category qualify.', icon: <MapPin size={24} className="text-neon-orange" /> },
              { num: '02', title: 'PLAYER AUCTIONS', desc: '192 total qualified players enter the MPPL auction pool. 8 franchises. One draft.', icon: <Gavel size={24} className="text-net-white" /> },
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 mb-20 text-left">
          ...
          <div className="bg-pure-black text-net-white p-8 border-2 border-pure-black shadow-[8px_8px_0px_rgba(0,0,0,0.4)] flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2 mt-auto">
              ...
              <div className="flex items-center gap-2">
                <CheckCircle2 size={15} className="text-neon-green shrink-0" />
                <span className="font-dm-sans text-xs text-net-white/80">192 total players in the draft pool</span>
              </div>
            </div>
          </div>
